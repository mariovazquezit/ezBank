...
<%--                                  <div class="col-md-2">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:DropDownList ID="cmbEstrategia" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="cmbEstrategia_SelectedIndexChanged">                  
                                        ...
                                        <asp:ListItem>Vencido Sin Particion</asp:ListItem>
                                        <asp:ListItem>MultiCuotas Integrales</asp:ListItem>
                                    </asp:DropDownList>
                               </div>
                                        
                                 <div class="col-md-2">
                                    <label>Depuración</label>
                                    <asp:DropDownList ID="cmbIndomiciliables" runat="server" CssClass="form-control">                  
                                        <asp:ListItem Selected>Sin Filtro</asp:ListItem> 
                                        <asp:ListItem>Eliminar Indomiciliables</asp:ListItem>                                         
                                    </asp:DropDownList>
                               </div>
